...
AGENT_DIRS=(
  academic design engineering finance game-development jarvis marketing paid-media product project-management
...
# The Agency (https://github.com/amjad2161/agency-agents).
#
